...
%Ref Mobley/Gilson review?
%MS Head suggests we also compare against null models
...
%I also originally had this in Aim 2, but since it applied to the whole proposal, it belongs with this node. "... we will ... run blind challenges on these datasets, and rapidly release the data to the community in an ongoing, rolling fashion."
