...
{\bf \underline{Aim 1.} Spur improvements in modeling protonation states, tautomers, and solvation via generation of new physical property datasets.}\\
...
{\bf \underline{Aim 2.} Measure high affinity binding of drug-like compounds in simple receptors to challenge quantitative models of binding in systems lacking sampling challenges often observed in protein-ligand binding.}\\
...
This will include binding studies on human serum albumin and either bromodomains or aspartyl proteases; initial binding data will be expanded by the selection of additional ligands or the creation of mutations in the protein that modulate binding.
