...
Expanding this domain will require focused work on carefully selected systems of intermediate complexity to bridge this gulf. 
...
We propose to collected targeted experimental datasets, use them to conduct blind prediction challenges, and release curated benchmark sets in a manner designed to drive expansion of the domain of applicability and robustness of physical modeling techniques. 
The data we generate will bridge the untamed chasm from systems tractable with current methodologies to the pharmaceutically-relevant drug targets featured in the NIH-funded D3R effort, which fields blind challenges using protein-ligand datasets from pharma.
Our systematic set of challenges aim to rapidly advance free energy techniques to the point of standard application in drug design.
...
We will measure new host-guest binding free energies (using cucurbiturils and deep-cavity cavitands as hosts) to field binding challenges which span in complexity between physical property prediction and protein-ligand binding. 
