...
This crowdsourcing model is proven to drive progress in a given area, both inside our community [refs] and for even more visible projects like Netflix [refs] and the XPrizes [ref]. 
...
The data we generate will allow several challenges of differing difficulty, between systems tractable with current methodologies to the pharmaceutically-relevant drug targets featured in the NIH-funded D3R effort [ref].
