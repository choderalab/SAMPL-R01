...
%JDC commented to give statistics here on number of publications and cite them, but that's up above (see "roughly 100" in the text) so I amended to say "noted above".
