...
% JDC further remarked: "I think it does help if we stress that we're going beyond what was already done, and see if we can communicate WHY it the proposed expansion of SAMPL is innovative and necessary, lest they think we should just carry on as we have without funding."
...
SAMPL challenges will have submission deadlines once yearly, though not every data type or component of Aims 1-3 will be annual.
...
%JDC: I think it will be better if it's clear that both of our labs are available to engage west and east coast pharma, as long as there is a clear leadership plan.
