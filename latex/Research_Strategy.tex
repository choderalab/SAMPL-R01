...
Here, we design a series of SAMPL challenges focused on two general classes of host-guest systems -- cucubiturils and derivatives, and deep-cavity cavitands -- both of which build in studies from prior SAMPLs.
...
\begin{center}
\textbf{Cucubituril-based receptors as model binding systems}
\end{center}
%Isaacs science
