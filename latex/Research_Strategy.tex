...
Our {\bf SAMPL series of Challenges has already proven it drives dramatic improvements of modeling}.
...
While SAMPL has already proven valuable, until now, \textbf{SAMPL relied on donated data and time}, making it impossible to design Challenges specifically to improve modeling as we propose. 
Despite these past limitations, our recent survey reveals that SAMPL has had a significant effect on the field and past participants are overwhelmingly enthusiastic~\cite{Mobley:2017:eScholarship}, including about these proposed plans. 
