...
Here, we will generate new experimental data on carefully selected and tailored systems, using it to drive a series of blind community challenges which will engage the community in testing and improving these methods, preparing the methods to have the dramatic impacts on human health that they promise. 
